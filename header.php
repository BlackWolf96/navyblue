...
<div class="carousel slide carousel-fade" id="carouselNavyBlue" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active"> 
            <img style="width:100%;" src="<?php echo get_template_directory_uri().'/images/nb_slider1.png';?>" alt="Complete here" /> 
        </div>
        <div class="carousel-item">
            <img style="width:100%;"src="<?php echo get_template_directory_uri().'/images/nb_slider2.png';?>" alt="Complete here" />
        </div>
    </div>
</div>
